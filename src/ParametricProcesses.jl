...
function distribute!(pm::ProcessManager, percentage::Float64, jobs::AbstractJob ...; not = Async, keyargs ...)
...
"""
```julia
distribute_open!(pm::ProcessManager, job::AbstractJob ...; not::Process = Async, sync::Bool = false) -> ::Vector{Int64}
```
